...
# Here we can just get the file name. If not just return the first one. 
print("This is the file for Transcripting:" + FILE_NAME_WAV)

FILE_NAME = FILE_NAME_WAV[:-4]

ORIGINAL_DIRECTORY = os.getcwd()
print("Set the ORIGINAL_DIRECTORY" + ORIGINAL_DIRECTORY)
...
print("==============Generated the spk2utt in ./data/test==============")

with open("utt2spk", "w") as f:
    f.write("{0} global".format(FILE_NAME))
print("==============Generated the utt2spk in ./data/test==============")


wav_path = os.getcwd() + "/" + FILE_NAME_WAV
with open("wav.scp", "w") as f:
    f.write("{0} {1}".format(FILE_NAME, wav_path))
print("==============Generated the wavscp  in ./data/test==============")

# Return to s5
os.chdir(ORIGINAL_DIRECTORY)
print("==============Return to the ORIGINAL_DIRECTORY" + ORIGINAL_DIRECTORY +"==============")
...
print("==============The sample rate in the .wav file is: " + str(sample_rate) + "==============")
...
with open("main_log.txt", "w") as f:
    ...
    print("==============Make MFCC features using configuration file provided==============")
    ...
    print("==============Download pre trained models if don't already have.==============")
    ...
    print("==============EXTRACT PRE TRAINED MODELS.==============")
    ...
    print("==============Create decoding graph using the small trigram language model.==============")    
    ...
    print("==============Decode using the created graph==============")    
